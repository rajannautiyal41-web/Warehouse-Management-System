    ...
    <div className="bg-[#0e3a6d] text-white font-sans">
      ...
      <div className="max-w-3xl mx-auto text-center pt-28 pb-24 px-4">
        ...
        <div className="flex justify-center gap-8 mt-6 opacity-90">
          ...
          {/* Windows */}
         <svg fill="#ffffff" height="40px" width="40px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 497.886 497.886" xmlSpace="preserve">
<g>
	<g>
		<g>
          ...
          {/* Android */}
        <svg fill="#ffffff" height="40px" width="40px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 57.001 57.001" xmlSpace="preserve">
<g>
	<g>
