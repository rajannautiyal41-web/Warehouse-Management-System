            ...
            <div className="w-full">
              ...
              <div className="mt-8 space-y-5 w-full">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className="bg-gray-100 rounded-xl p-4 flex flex-col md:flex-row gap-4 md:gap-6 w-full hover:shadow-md transition"
                  >
                    {/* IMAGE */}
                    <img
                      src={item.image}
                      alt={item.name}
                      className="w-full md:w-[160px] h-[160px] object-cover rounded-lg"
                    />
